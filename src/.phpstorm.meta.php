...
'filesystems.links./var/www/public/storage','inertia.ssr.enabled','inertia.ssr.url','inertia.ensure_pages_exist','inertia.page_paths',
...
'scans.show','scans.destroy','storage.local',);
